...
gsap.to("#page>video",{
  scrollTrigger:{
    trigger:`#page>video`,            //triggers the video
    start:`2% top`,                   
    end:`bottom top`,
    // markers:true,
    scroller:`#main`
  },
  onStart:()=>{                     //This is a callback function that will be executed when the animation starts
...
var textUp = gsap.timeline({                    //timeline allows you to sequence and manage animations over time
  scrollTrigger:{                               //trigger animations based on scroll positions.
      trigger:`#page1`,                         //When the user scrolls to this element, the animation will be triggered.
      start:`top top`,                          //animation will start when the top of the trigger element reaches the top of the viewport.
      scrub:1,                                  //it means the animation will follow the scroll position linearly. 
      scroller:`#main`,                         //It means that the animation will be controlled by scrolling inside the element with the ID "main". 
      pin:true                                  //the trigger element will be "pinned" to a fixed position on the screen
  }
})


textUp.to("#page1>h1",{                         
  top:`-50%`                                    //This will cause the element to slide upward during the scrubbing effect.
})


var textUp2 = gsap.timeline({                    
  scrollTrigger:{                               
      trigger:`#page2`,                         //When the user scrolls to this element, the animation will be triggered.
      start:`top top`,                          //animation will start when the top of the trigger element reaches the top of the viewport.
      scrub:1,                                  //it means the animation will follow the scroll position linearly. 
      scroller:`#main`,                         //It means that the animation will be controlled by scrolling inside the element with the ID "main". 
      pin:true                                  //the trigger element will be "pinned" to a fixed position on the screen
...
textUp22.to("#page22>h2",{                         
  top:`-50%`                                    //This will cause the element to slide upward during the scrubbing effect.
})


var textUp23 = gsap.timeline({                    //timeline allows you to sequence and manage animations over time
  scrollTrigger:{                               //trigger animations based on scroll positions.
      trigger:`#page23`,                         //When the user scrolls to this element, the animation will be triggered.
      start:`top top`,                          //animation will start when the top of the trigger element reaches the top of the viewport.
      scrub:1,                                  //it means the animation will follow the scroll position linearly. 
      scroller:`#main`,                         //It means that the animation will be controlled by scrolling inside the element with the ID "main". 
      pin:true                                  //the trigger element will be "pinned" to a fixed position on the screen
...
tl51.to("#page51>#center-page5",{
  top:`-50%`
})

var tl53 = gsap.timeline({
  scrollTrigger:{
      trigger:`#page53`,
      start:`top top`,
      scrub:1,
